...
map.getView().fit([-4264996.448901, -1426366.847172, -4262978.709663, -1425239.446272], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cadastro de Equipamentos e Consultas SEDUR-PMC</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (73 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapeamento online desenvolvido pela CPP/SEDUR baseado e softwares livres.';
            }
