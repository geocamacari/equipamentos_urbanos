var wms_layers = [];
    ...
    attributions: ' &middot; <a href="https://www.google.at/permissions/geoguidelines/attr-guide.html">Map data ©2015 Google</a>',
        ...
        var lyr_GoogleTrafficonline_2 = new ol.layer.Tile({
...
var format_RiosPerenesSEIBa25k_5 = new ol.format.GeoJSON();
var features_RiosPerenesSEIBa25k_5 = format_RiosPerenesSEIBa25k_5.readFeatures(json_RiosPerenesSEIBa25k_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RiosPerenesSEIBa25k_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RiosPerenesSEIBa25k_5.addFeatures(features_RiosPerenesSEIBa25k_5);
var lyr_RiosPerenesSEIBa25k_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RiosPerenesSEIBa25k_5,
maxResolution:28.00446615226196,
 minResolution:0.28004466152261964,

                style: style_RiosPerenesSEIBa25k_5,
                popuplayertitle: "Rios Perenes (SEI-Ba, 25k)",
                interactive: true,
                title: '<img src="styles/legend/RiosPerenesSEIBa25k_5.png" /> Rios Perenes (SEI-Ba, 25k)'
            });
...
var format_OutrosEquipInstitucionaiseComerciais2025_8 = new ol.format.GeoJSON();
var features_OutrosEquipInstitucionaiseComerciais2025_8 = format_OutrosEquipInstitucionaiseComerciais2025_8.readFeatures(json_OutrosEquipInstitucionaiseComerciais2025_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_OutrosEquipInstitucionaiseComerciais2025_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_OutrosEquipInstitucionaiseComerciais2025_8.addFeatures(features_OutrosEquipInstitucionaiseComerciais2025_8);
var lyr_OutrosEquipInstitucionaiseComerciais2025_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_OutrosEquipInstitucionaiseComerciais2025_8,
maxResolution:7.00111653806549,
 minResolution:0.28004466152261964,

                style: style_OutrosEquipInstitucionaiseComerciais2025_8,
                popuplayertitle: "Outros Equip. Institucionais e Comerciais (2025)",
                interactive: true,
                title: '<img src="styles/legend/OutrosEquipInstitucionaiseComerciais2025_8.png" /> Outros Equip. Institucionais e Comerciais (2025)'
            });
...
var format_EquipPubAssistSocialout23_12 = new ol.format.GeoJSON();
var features_EquipPubAssistSocialout23_12 = format_EquipPubAssistSocialout23_12.readFeatures(json_EquipPubAssistSocialout23_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubAssistSocialout23_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubAssistSocialout23_12.addFeatures(features_EquipPubAssistSocialout23_12);
var lyr_EquipPubAssistSocialout23_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubAssistSocialout23_12,
maxResolution:7.00111653806549,
 minResolution:0.28004466152261964,

                style: style_EquipPubAssistSocialout23_12,
                popuplayertitle: "Equip. Pub. Assist Social (out/23)",
                interactive: true,
                title: '<img src="styles/legend/EquipPubAssistSocialout23_12.png" /> Equip. Pub. Assist Social (out/23)'
            });
var format_EquipEducaoout23_13 = new ol.format.GeoJSON();
var features_EquipEducaoout23_13 = format_EquipEducaoout23_13.readFeatures(json_EquipEducaoout23_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipEducaoout23_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipEducaoout23_13.addFeatures(features_EquipEducaoout23_13);
var lyr_EquipEducaoout23_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipEducaoout23_13,
maxResolution:14.00223307613098,
 minResolution:0.28004466152261964,

                style: style_EquipEducaoout23_13,
                popuplayertitle: "Equip. Educação (out/23)",
                interactive: true,
                title: '<img src="styles/legend/EquipEducaoout23_13.png" /> Equip. Educação (out/23)'
            });
var format_EquipPubSadeout23_14 = new ol.format.GeoJSON();
var features_EquipPubSadeout23_14 = format_EquipPubSadeout23_14.readFeatures(json_EquipPubSadeout23_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EquipPubSadeout23_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EquipPubSadeout23_14.addFeatures(features_EquipPubSadeout23_14);
var lyr_EquipPubSadeout23_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EquipPubSadeout23_14,
maxResolution:14.00223307613098,
 minResolution:0.28004466152261964,

                style: style_EquipPubSadeout23_14,
                popuplayertitle: "Equip. Pub. Saúde (out/23)",
                interactive: true,
                title: '<img src="styles/legend/EquipPubSadeout23_14.png" /> Equip. Pub. Saúde (out/23)'
            });
var format_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15 = new ol.format.GeoJSON();
var features_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15 = format_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15.readFeatures(json_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15.addFeatures(features_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15);
var lyr_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15,
maxResolution:14.00223307613098,
 minResolution:0.28004466152261964,

                style: style_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15,
                popuplayertitle: "Poligonais_Consultas Previas_pos_PDDU-S_mapa",
                interactive: true,
                title: '<img src="styles/legend/Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15.png" /> Poligonais_Consultas Previas_pos_PDDU-S_mapa'
            });
...
var format_Bairros_Enderecamento_2022_CNEFE_23 = new ol.format.GeoJSON();
var features_Bairros_Enderecamento_2022_CNEFE_23 = format_Bairros_Enderecamento_2022_CNEFE_23.readFeatures(json_Bairros_Enderecamento_2022_CNEFE_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Bairros_Enderecamento_2022_CNEFE_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Bairros_Enderecamento_2022_CNEFE_23.addFeatures(features_Bairros_Enderecamento_2022_CNEFE_23);
var lyr_Bairros_Enderecamento_2022_CNEFE_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Bairros_Enderecamento_2022_CNEFE_23,
maxResolution:84.0133984567859,
 minResolution:1.4002233076130983,

                style: style_Bairros_Enderecamento_2022_CNEFE_23,
                popuplayertitle: "Bairros_Enderecamento_2022_CNEFE",
                interactive: true,
                title: '<img src="styles/legend/Bairros_Enderecamento_2022_CNEFE_23.png" /> Bairros_Enderecamento_2022_CNEFE'
            });
...
lyr_OSMStandard_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleTrafficonline_2.setVisible(false);lyr_GoogleLabels_3.setVisible(false);lyr_EsriBoundariesandPlaces_4.setVisible(true);lyr_RiosPerenesSEIBa25k_5.setVisible(false);lyr_Trecho_Massa_DaguaConder2010_6.setVisible(true);lyr_Massa_DaguaConder2010_7.setVisible(true);lyr_OutrosEquipInstitucionaiseComerciais2025_8.setVisible(false);lyr_EquipPubEsportejan23_9.setVisible(false);lyr_EquipPubPraasParquesoutrosjan23_10.setVisible(false);lyr_EquipPubCulturaisout21_11.setVisible(false);lyr_EquipPubAssistSocialout23_12.setVisible(false);lyr_EquipEducaoout23_13.setVisible(false);lyr_EquipPubSadeout23_14.setVisible(false);lyr_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15.setVisible(false);lyr_PraasdePedgiorodestaduais_16.setVisible(true);lyr_LogradourosOficializadoseouCepeados_17.setVisible(true);lyr_LinhaFrreaFCA_18.setVisible(true);lyr_EixosRodEstSEINFRABa2021_19.setVisible(false);lyr_PassarelasemRodovias_20.setVisible(true);lyr_Paradasdenibusemrodovias2022_21.setVisible(true);lyr_Localidadesdiversas2023_22.setVisible(true);lyr_Bairros_Enderecamento_2022_CNEFE_23.setVisible(false);lyr_DistritosMunicipais2020_24.setVisible(false);lyr_LimitesMunicpiosRMS2020_25.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_GoogleSatellite_1,lyr_GoogleTrafficonline_2,lyr_GoogleLabels_3,lyr_EsriBoundariesandPlaces_4,lyr_RiosPerenesSEIBa25k_5,lyr_Trecho_Massa_DaguaConder2010_6,lyr_Massa_DaguaConder2010_7,lyr_OutrosEquipInstitucionaiseComerciais2025_8,lyr_EquipPubEsportejan23_9,lyr_EquipPubPraasParquesoutrosjan23_10,lyr_EquipPubCulturaisout21_11,lyr_EquipPubAssistSocialout23_12,lyr_EquipEducaoout23_13,lyr_EquipPubSadeout23_14,lyr_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15,lyr_PraasdePedgiorodestaduais_16,lyr_LogradourosOficializadoseouCepeados_17,lyr_LinhaFrreaFCA_18,lyr_EixosRodEstSEINFRABa2021_19,lyr_PassarelasemRodovias_20,lyr_Paradasdenibusemrodovias2022_21,lyr_Localidadesdiversas2023_22,lyr_Bairros_Enderecamento_2022_CNEFE_23,lyr_DistritosMunicipais2020_24,lyr_LimitesMunicpiosRMS2020_25];
lyr_RiosPerenesSEIBa25k_5.set('fieldAliases', {'Id': 'Id', 'nome': 'nome', 'regime': 'regime', });
...
lyr_OutrosEquipInstitucionaiseComerciais2025_8.set('fieldAliases', {'id': 'id', 'nome': 'nome', 'tipo': 'tipo', 'setor': 'setor', 'bairro': 'bairro', 'distrito': 'distrito', 'situação': 'situação', 'gestão': 'gestão', 'observaç�': 'observaç�', 'fonte': 'fonte', 'revisão': 'revisão', });
...
lyr_EquipPubAssistSocialout23_12.set('fieldAliases', {'id': 'id', 'unidade': 'unidade', 'local': 'local', 'contato': 'contato', 'obs.': 'obs.', 'tipo': 'tipo', 'bairro': 'bairro', 'distrito': 'distrito', 'org.': 'org.', 'Abrangenci': 'Abrangenci', 'link': 'link', });
lyr_EquipEducaoout23_13.set('fieldAliases', {'id': 'id', 'tipo': 'tipo', 'cod_inep': 'cod_inep', 'nome_compl': 'nome_compl', 'distrito': 'distrito', 'numero': 'numero', 'bairro': 'bairro', 'nome_anter': 'nome_anter', 'salas': 'salas', 'endereco': 'endereco', 'turmas_exi': 'turmas_exi', 'gestão': 'gestão', 'org.': 'org.', 'LINK': 'LINK', 'Obs.': 'Obs.', });
lyr_EquipPubSadeout23_14.set('fieldAliases', {'id': 'id', 'name': 'name', 'descriptio': 'descriptio', 'tipo': 'tipo', 'fonte': 'fonte', 'bairro': 'bairro', 'distrito': 'distrito', 'cnes': 'cnes', 'n. gestão': 'n. gestão', 'org.': 'org.', 'LINK': 'LINK', 'LINK_2': 'LINK_2', });
lyr_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15.set('fieldAliases', {'id': 'id', 'processo': 'processo', 'interessad': 'interessad', 'obs.': 'obs.', 'Analista': 'Analista', 'area_Ha': 'area_Ha', 'area_m2': 'area_m2', 'STATUS': 'STATUS', 'PRODUTOS': 'PRODUTOS', 'Data_anali': 'Data_anali', 'BAIRRO': 'BAIRRO', 'Compatibil': 'Compatibil', 'perímetro': 'perímetro', 'área_elip': 'área_elip', 'perímet_1': 'perímet_1', 'área_el_1': 'área_el_1', 'perímetro_elip_m': 'perímetro_elip_m', 'área_elip_m²': 'área_elip_m²', });
...
lyr_LogradourosOficializadoseouCepeados_17.set('fieldAliases', {'id': 'id', 'codlog_': 'codlog_', 'logradour_': 'logradour_', 'parcelame_': 'parcelame_', 'bairro_': 'bairro_', 'distrito_': 'distrito_', 'cep_': 'cep_', 'obs_1': 'obs_1', 'obs_2': 'obs_2', 'catalogo_': 'catalogo_', 'webmap': 'webmap', 'class.2': 'class.2', 'compriment': 'compriment', 'MAPA': 'MAPA', });
...
lyr_RiosPerenesSEIBa25k_5.set('fieldImages', {'Id': 'TextEdit', 'nome': 'TextEdit', 'regime': 'TextEdit', });
...
lyr_OutrosEquipInstitucionaiseComerciais2025_8.set('fieldImages', {'id': 'TextEdit', 'nome': 'TextEdit', 'tipo': 'TextEdit', 'setor': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'situação': 'TextEdit', 'gestão': 'TextEdit', 'observaç�': 'TextEdit', 'fonte': 'TextEdit', 'revisão': 'TextEdit', });
...
lyr_EquipPubAssistSocialout23_12.set('fieldImages', {'id': 'TextEdit', 'unidade': 'TextEdit', 'local': 'TextEdit', 'contato': 'TextEdit', 'obs.': 'TextEdit', 'tipo': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'org.': 'TextEdit', 'Abrangenci': '', 'link': '', });
lyr_EquipEducaoout23_13.set('fieldImages', {'id': 'Range', 'tipo': 'TextEdit', 'cod_inep': 'TextEdit', 'nome_compl': 'TextEdit', 'distrito': 'TextEdit', 'numero': 'TextEdit', 'bairro': 'TextEdit', 'nome_anter': 'TextEdit', 'salas': 'TextEdit', 'endereco': 'TextEdit', 'turmas_exi': 'TextEdit', 'gestão': 'TextEdit', 'org.': 'TextEdit', 'LINK': '', 'Obs.': '', });
lyr_EquipPubSadeout23_14.set('fieldImages', {'id': 'Range', 'name': 'TextEdit', 'descriptio': 'TextEdit', 'tipo': 'TextEdit', 'fonte': 'TextEdit', 'bairro': 'TextEdit', 'distrito': 'TextEdit', 'cnes': 'TextEdit', 'n. gestão': 'TextEdit', 'org.': 'TextEdit', 'LINK': '', 'LINK_2': '', });
lyr_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15.set('fieldImages', {'id': 'TextEdit', 'processo': 'TextEdit', 'interessad': 'TextEdit', 'obs.': 'TextEdit', 'Analista': 'TextEdit', 'area_Ha': 'TextEdit', 'area_m2': 'TextEdit', 'STATUS': 'TextEdit', 'PRODUTOS': 'TextEdit', 'Data_anali': 'TextEdit', 'BAIRRO': 'TextEdit', 'Compatibil': 'TextEdit', 'perímetro': 'TextEdit', 'área_elip': 'TextEdit', 'perímet_1': '', 'área_el_1': '', 'perímetro_elip_m': 'TextEdit', 'área_elip_m²': 'TextEdit', });
...
lyr_LogradourosOficializadoseouCepeados_17.set('fieldImages', {'id': 'TextEdit', 'codlog_': 'TextEdit', 'logradour_': 'TextEdit', 'parcelame_': 'TextEdit', 'bairro_': 'TextEdit', 'distrito_': 'TextEdit', 'cep_': 'TextEdit', 'obs_1': 'TextEdit', 'obs_2': 'TextEdit', 'catalogo_': '', 'webmap': 'TextEdit', 'class.2': '', 'compriment': 'TextEdit', 'MAPA': '', });
...
lyr_Bairros_Enderecamento_2022_CNEFE_23.set('fieldImages', {'id': 'TextEdit', 'nm_bairro': 'TextEdit', 'cod_bairro': 'TextEdit', 'distrito': 'TextEdit', 'situação': 'TextEdit', 'bairros': 'TextEdit', 'rotulos': 'TextEdit', 'CNEFE 2022': '', 'Hab_Dom': '', 'PopEst_22': '', 'area_Ha': '', 'Perim_km': '', 'Pop_est_24': '', 'area_km2': '', 'Dens_km2': '', 'Dens_Ha': '', 'hab_dom_1': '', });
...
lyr_RiosPerenesSEIBa25k_5.set('fieldLabels', {'Id': 'inline label - always visible', 'nome': 'inline label - always visible', 'regime': 'inline label - always visible', });
...
lyr_Massa_DaguaConder2010_7.set('fieldLabels', {'FID_HID_Ma': 'inline label - always visible', 'nome': 'inline label - always visible', 'geometriaA': 'inline label - always visible', 'regime': 'inline label - always visible', 'nomeAbrev': 'inline label - always visible', 'tipoMassaD': 'inline label - always visible', 'salinidade': 'inline label - always visible', 'FID_Articu': 'inline label - always visible', 'OBJECTID_1': 'inline label - always visible', 'MI': 'inline label - always visible', 'Escala': 'inline label - always visible', 'Nome_Carta': 'inline label - always visible', 'Ano_Aquisi': 'inline label - always visible', 'Shape_Leng': 'inline label - always visible', 'BLOCO': 'inline label - always visible', 'Equidistan': 'inline label - always visible', 'Ano_Aqui_1': 'inline label - always visible', 'Shape_Le_1': 'inline label - always visible', 'Shape_Ar_1': 'inline label - always visible', 'Shape_Le_2': 'inline label - always visible', 'Shape_Area': 'inline label - always visible', });
lyr_OutrosEquipInstitucionaiseComerciais2025_8.set('fieldLabels', {'id': 'inline label - always visible', 'nome': 'no label', 'tipo': 'inline label - always visible', 'setor': 'no label', 'bairro': 'hidden field', 'distrito': 'hidden field', 'situação': 'no label', 'gestão': 'inline label - always visible', 'observaç�': 'hidden field', 'fonte': 'hidden field', 'revisão': 'no label', });
...
lyr_EquipPubAssistSocialout23_12.set('fieldLabels', {'id': 'hidden field', 'unidade': 'inline label - always visible', 'local': 'inline label - always visible', 'contato': 'hidden field', 'obs.': 'hidden field', 'tipo': 'inline label - always visible', 'bairro': 'inline label - always visible', 'distrito': 'inline label - always visible', 'org.': 'inline label - always visible', 'Abrangenci': 'inline label - always visible', 'link': 'inline label - always visible', });
lyr_EquipEducaoout23_13.set('fieldLabels', {'id': 'inline label - always visible', 'tipo': 'inline label - always visible', 'cod_inep': 'hidden field', 'nome_compl': 'inline label - always visible', 'distrito': 'hidden field', 'numero': 'hidden field', 'bairro': 'hidden field', 'nome_anter': 'hidden field', 'salas': 'hidden field', 'endereco': 'hidden field', 'turmas_exi': 'hidden field', 'gestão': 'inline label - always visible', 'org.': 'hidden field', 'LINK': 'hidden field', 'Obs.': 'hidden field', });
lyr_EquipPubSadeout23_14.set('fieldLabels', {'id': 'inline label - always visible', 'name': 'inline label - always visible', 'descriptio': 'inline label - always visible', 'tipo': 'inline label - always visible', 'fonte': 'hidden field', 'bairro': 'hidden field', 'distrito': 'hidden field', 'cnes': 'hidden field', 'n. gestão': 'inline label - always visible', 'org.': 'hidden field', 'LINK': 'hidden field', 'LINK_2': 'hidden field', });
lyr_Poligonais_ConsultasPrevias_pos_PDDUS_mapa_15.set('fieldLabels', {'id': 'inline label - always visible', 'processo': 'inline label - always visible', 'interessad': 'inline label - always visible', 'obs.': 'inline label - always visible', 'Analista': 'inline label - always visible', 'area_Ha': 'inline label - always visible', 'area_m2': 'inline label - always visible', 'STATUS': 'inline label - always visible', 'PRODUTOS': 'inline label - always visible', 'Data_anali': 'inline label - always visible', 'BAIRRO': 'inline label - always visible', 'Compatibil': 'inline label - always visible', 'perímetro': 'inline label - always visible', 'área_elip': 'inline label - always visible', 'perímet_1': 'no label', 'área_el_1': 'no label', 'perímetro_elip_m': 'inline label - always visible', 'área_elip_m²': 'inline label - always visible', });
...
lyr_Bairros_Enderecamento_2022_CNEFE_23.set('fieldLabels', {'id': 'hidden field', 'nm_bairro': 'inline label - always visible', 'cod_bairro': 'hidden field', 'distrito': 'inline label - always visible', 'situação': 'hidden field', 'bairros': 'hidden field', 'rotulos': 'hidden field', 'CNEFE 2022': 'inline label - always visible', 'Hab_Dom': 'hidden field', 'PopEst_22': 'inline label - always visible', 'area_Ha': 'inline label - always visible', 'Perim_km': 'inline label - always visible', 'Pop_est_24': 'inline label - always visible', 'area_km2': 'inline label - always visible', 'Dens_km2': 'inline label - always visible', 'Dens_Ha': 'inline label - always visible', 'hab_dom_1': 'hidden field', });
